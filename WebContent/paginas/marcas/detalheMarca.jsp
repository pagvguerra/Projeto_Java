...
<form name="form">
<input type="hidden" name="id" id="id" value="${marcaBean.id}">
<input type="hidden" name="acao" id="acao" value="">
						<br/><br/>
				
				<fieldset>
					<legend>Alterar Marcas</legend>
<br/><br/>
<div class="form-group">
Marca ..: <input class="form-control" type="text" name="nome" id="nome" value="${marcaBean.nome}">
</div>
<br/><br/>
